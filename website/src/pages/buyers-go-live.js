...
const info_sections = [

  {
    ...
    description: (
      <>
      We're running a select group of Apps through the Dreamcatcher process and will be looking for Buyers to contribute both by identifying Apps that they would like built and to the testing of the Dreamcatcher.
<><br></br></><><br></br></>
      If you're interested in getting involved we're asking for a small test payment of $5.
