For the current folder or the folder specified in a complete path, lists the instatiations of the Objects which have been added using the add command in that folder.
