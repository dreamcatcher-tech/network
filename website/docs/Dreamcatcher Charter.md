...
1. No power over users - this is a decentralized app, so we cannot kick anyone off the platform, but we can revoke their legal DPL license if they behave badly, just as the GPL does.
