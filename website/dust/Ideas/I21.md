...
This document provides an idea in response to [Requests/R24](../Requests/R24) IPFS ORM. We seek to define an MVP spec that serves the requests set out there. 
...
await iporm.crush.DMZ(dmzInstance, encrypter)
```
