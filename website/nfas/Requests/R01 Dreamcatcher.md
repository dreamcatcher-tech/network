...
We assume that, given the likely granularity and fidelity required, the Strategic Intent is best met by building an App on [Interblock](https://github.com/dreamcatcher-tech/dreamcatcher-tech.github.io/blob/master/website/nfas/Requests/06%20Interblock.md) so it inherits Interblock's capabilities to provide a trusted, distributed, granular system. This App would have the following properties:
