...
In this process, the NFT is in two phases - potential and kinetic.  The potential phase could be a security, but the participation requirement stops that.  The kinetic phase could be a security, but the decentralized attribution stops that, as there is no 
...
Each NFT can still have late funding opensea units purchased, which the owners of the packet may accept or not.
