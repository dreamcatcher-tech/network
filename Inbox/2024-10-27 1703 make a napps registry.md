...
Because napps are purely interface, dependency injection is by default - it forces interface definitions, rather than making them optional.  Interface equivalence is easy to have.
## Competitors
