...
We should be able to queue up operations that can be done upon the completion of some prize. So we can lay out what our milestones are going to be. These can be used for project planning and estimation purposes, but once the milestones are reached, we can automatically begin the process that was laid out for them. This is quite useful because it keeps the humans on track and shows everyone else where we are heading.

But often, while you're in the weeds, you learn a lot about what you're going to do once you're out of the weeds. So this should be captured somewhere and laid down somewhere useful so that in the best case scenario as soon as you've got out of the weeds immediately all of the rest of the work required automatically executes and spits out an answer at the bottom. 