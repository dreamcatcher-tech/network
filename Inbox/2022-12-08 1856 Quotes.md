...
Basically a framework for AIs to program with and be programmed interactively with humans.  Like a wikipedia and a stack overflow for AIs to collab with humans on.