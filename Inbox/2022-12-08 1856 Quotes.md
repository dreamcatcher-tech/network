...
The greatest failure is something sufficient but impure.  Like the web, being an imperfect version of a pure thing like transclusion, but it becomes entrenched and absorbs any further energy required to move it towards the pure thing.  The local maxima.  It deceives, and it emburdens those who would other reach full potential.  The false God, as it were.