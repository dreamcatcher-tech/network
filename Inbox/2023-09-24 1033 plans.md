...
First to tackle the biggest inefficiencies in the innovation marketplace, we need to make it fit a predefined structure.  The biggest inefficiency is the lack of automation.  Standardization like threads, production lines.  Tools need standards.  Biggest interface issue of all is natural language.
...
If global mfg is a global supply chain, how come software isn't ? how come software parts aren't commercially interchangeable.

Could measure friction in trade by gas costs.

faceless stops all the reinventing of the wheel stuff.
...
Test cases can be direct user prompts that happened.

Prompts are published when packet is published ?

Publish packet includes the prompting costs.
Let people pay for packets by credit card.

Share a summary of the chats that the solutions are having with the packets ?
AI acts like a privacy guard, where it hides individual statements, and summarizing issues with the packet.  Then it can ask more questions to help refine the packet.
Also difficutl to parse all the statements.
Push notifications - issues people are having, edits proposed by the AI because of those problems, and questions required to make more changes.

This public chain with self sovereign data removes the problems of data privacy rights completely, as the processing systems never keep the data.