...
## Medivac packages
If we know the local doctor, and have him on speed dial, plus know the insurance providers, then we can provide an NFT purchasable package to guarantee medical cover.  Also provide stats like time to available medical attention.  Then if we could get a doctor on the island, that is another win.