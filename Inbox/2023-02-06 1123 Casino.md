...
Describe strategies and have it test them for you.
## Large capital pool DEX
Make a DEX that can be used for any kind of risk game using an interface that is suitable for casino games.  Get the pool big fast, and it won't matter that all the contracts are open source, as the capital pool is what holds people together.

Then anyone can start a game and use the DEX to access capital.

Excess winnings in the DEX go to second chance winning on ventures.

People set the price of their funding, so anyone can take it at whatever odds.  If the contract code matches one of the verified contracts then you can have access to the dex pool of funds.

Enter ground based casinos if we can install our decentralized machines.  Make a roulette table that is automated and operates transparently.