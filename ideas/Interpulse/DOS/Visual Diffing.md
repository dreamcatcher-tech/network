>[!tip] Created: [2022-10-20 Thu 16:39]

>[!question] Targets: [[Offline Apps]]

>[!danger] Depends: 

When Datums come in, they may have conflicts.  Being able to display these in an easy to understand way makes it easier than having some separate type of workflow to handle conflicts.
...
This feature is critical of [[Offline Apps]], where an owner can take the entire application, work offline for several days, then merge back in their changes, gracefully handling any conflicts with others that might have occured.