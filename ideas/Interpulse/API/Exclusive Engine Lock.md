...
To remedy this, we should allow the option to lock the engine by putting it in transaction mode, which will buffer all other piece actions in to it until the transaction is commited.